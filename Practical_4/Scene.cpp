...
Scene::Scene()
{
    ...
    // Wall
    shapes[1] = new Box(Vector(3, new double[3]{0, 0, -0.1}), 0.6, 0.8, 0.05, Vector(3, new double[3]{1, 0, 0}));

    // Window
    shapes[2] = new Box(Vector(3, new double[3]{0, 0, 0}), 0.6, 0.8, 0.1, Vector(3, new double[3]{0, 0.8, 0}));
